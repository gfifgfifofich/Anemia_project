...
void AAnemia_ue5Character::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AAnemia_ue5Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AAnemia_ue5Character::Move);
...
void AAnemia_ue5Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AAnemia_ue5Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
